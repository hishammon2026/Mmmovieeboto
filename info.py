...
BOT_TOKEN = environ.get('BOT_TOKEN', "8627582266:AAHgTO-eh87dDxy5wIHCcB9TaN9asm8FBwI")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://i.ibb.co/hRVjSQh0/x.jpg')).split()  # Sample pic
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Database:Database@cluster0.7jreuiw.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '100381743760'))  # Notification of sent to your channel
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+ddiTlqQ3ac1kYTZl') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/hishammon') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+icsASUjSA7hmMmJl') # Update channel link for the bot
